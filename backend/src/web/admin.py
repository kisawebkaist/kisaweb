...
admin_site = CustomAdminSite(name="KISA Admin")
...
# change the site variable from the django admin module
# so that when, later, the other application are loaded
# we can register to the admin site like in the offical
# documentation
