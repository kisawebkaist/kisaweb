...
class Alumni(models.Model):
    ...
    joined_year = models.IntegerField(default=2023)
    ...
    separated_year = models.IntegerField(blank=True,null=True, help_text='If the alumni only worked for one season please leave this part empty.')
    worked_positions = models.ManyToManyField(KISA_Positions, blank=False)
