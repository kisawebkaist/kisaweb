...
else{$div_id.hide();}});$('#id_image_height').change(function(){$val=$(this).val();if($val<0){alert('Please enter a positive integer');$(this).val($(this).attr('value'));}
else{if($(this).attr('id')==='#id_image_height'){$event_image_preview.height($val);}
