...
class Event(models.Model):
    ...
    participants = models.ManyToManyField(settings.AUTH_USER_MODEL, related_name='faq_participants', blank=True)
    ...
    def image_tag(self, css_class='', tag_id=None, listview=False):
        ...
        return mark_safe(
            f'<img src="{path}" class="{css_class}" {tag_id_str} alt="Event Image" width="{width}" height="{height}" />')
