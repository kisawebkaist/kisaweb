    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "location",
                    models.CharField(blank=True, default="TBA", max_length=100),
                ),
                (
                    "is_link",
                    models.BooleanField(
                        default=False, verbose_name="Event is online (i.e. has link)"
                    ),
                ),
                ...
                (
                    "descr_truncate_num",
                    models.PositiveSmallIntegerField(blank=True, default=50),
                ),
                (
                    "image",
                    models.ImageField(blank=True, null=True, upload_to="events/img"),
                ),
                (
                    "image_height",
                    models.PositiveSmallIntegerField(blank=True, default=260),
                ),
                (
                    "image_width",
                    models.PositiveSmallIntegerField(blank=True, default=260),
                ...
                (
                    "participants",
                    models.ManyToManyField(blank=True, to="sso.kaistprofile"),
                ),
            ],
            options={
                "ordering": ["-id"],
